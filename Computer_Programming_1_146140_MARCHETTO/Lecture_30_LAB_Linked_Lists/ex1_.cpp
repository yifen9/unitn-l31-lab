...
int main(){
    ...
    while(true){
        ...
        switch(choice){
            case 0: return 0;
            case 1: egList = "ex1-eg1-list.txt"; egSublist = "ex1-eg1-sublist.txt"; break;
            case 2: egList = "ex1-eg2-list.txt"; egSublist = "ex1-eg2-sublist.txt"; break;
            case 3: egList = "ex1-eg3-list.txt"; egSublist = "ex1-eg3-sublist.txt"; break;
